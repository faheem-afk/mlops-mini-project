...
max_features = yaml.safe_load(
    open('params.yaml', 'r'))['feature_engineering']['max_features']
train_preprocessed_df = pd.read_csv(
    "data/preprocessed/train_preprocessed_data.csv").dropna(axis=0)
test_preprocessed_df = pd.read_csv(
    "data/preprocessed/test_preprocessed_data.csv").dropna(axis=0)
